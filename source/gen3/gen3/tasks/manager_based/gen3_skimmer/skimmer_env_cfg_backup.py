...
class Gen3SkimmerEnvCfg(ReachEnvCfg):
    def __post_init__(self):
        ...
        self.events.reset_robot_joints.params["position_range"] = (1.0, 1.0) # don't change
        ...
        self.rewards.end_effector_position_tracking.weight = -0.5 # negative
        ...
        orientation_tracking_eff_transform_z_target_weight = -0.75 # negative
